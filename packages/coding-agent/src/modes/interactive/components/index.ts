...
export { ConfigProfileSelectorComponent } from "./config-profile-selector.ts";
...
export { SproutaiStartupHeader } from "./sproutai-startup-header.ts";
export { setStartupTipProvider, getStartupTipProvider, type StartupTipProvider } from "./sproutai-startup-header.ts";
