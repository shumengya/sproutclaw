...
export const defaultMarkdownTheme: MarkdownTheme = {
	...
	headingMuted: (text: string) => chalk.bold.blue(text),
	...
	tableBorder: (text: string) => chalk.dim(text),
	kbd: (text: string) => chalk.bgGray.white(text),
	mark: (text: string) => chalk.bgYellow.black(text),
