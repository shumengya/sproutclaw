...
`Sprout` (又称 SproutAI , SproutClaw , SproutBot)是一个面向服务器运维与日常开发,办公协作的通用 AI Agent 助手，基于 [pi-agent](https://github.com/earendil-works/pi) 改造而来，重点开发插件扩展系统,定时任务系统,WebUI界面,以及各种深度定制魔改,致力于打造一款个人专属Agent
